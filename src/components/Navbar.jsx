...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="bg-slate-950   h-[75px] w-[98vw]  mx-2 fixed top-0   mb-5 rounded-b-2xl   md:rounded-none  md:m-0 p-0 border border-slate-900 shadow-md items-center align-middle ">
