...
},
{
  ...
  return (
    <div>
      <section className="flex flex-col md:flex-row items-center justify-center   gap-4  md:mt-20 md:max-h-screen md:w-screen m-[4px] md:m-0">
        <div className="  border border-slate-900  items-center justify-center md:w-[30vw] h-full md:h-[500px] rounded-2xl text-white bg-slate-950   ">
